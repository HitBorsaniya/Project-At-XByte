...
for item in data:
    ...
    for key, value in asin.items():
        ...
        cost = tree1.xpath('//div[@class="a-section a-spacing-none aok-align-center aok-relative"]//span[@class="a-price-whole"]/text()')[0].strip() or " "
        color = tree1.xpath('//span[text()=" Colour: "]/following-sibling::span/text()')[0].strip() or " "
        size = tree1.xpath('//span[text()=" Size: "]/following-sibling::span/text()')[0].strip() or " "
